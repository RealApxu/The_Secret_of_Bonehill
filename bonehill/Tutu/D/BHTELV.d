...
CreateCreature("%tutu_scripth%obelite",[999.1101],13)
CreateCreature("%tutu_scripth%obelite",[1188.993],14)
CreateCreature("%tutu_scripth%obelite",[1426.941],2)
CreateCreature("%tutu_scripth%obelite",[1639.1105],3)
CreateCreature("%tutu_scripth%obelite",[1147.1453],9)
CreateCreature("%tutu_scripth%obelite",[1276.1546],9)
CreateCreature("%tutu_scripth%obelite",[1790.1051],3)
CreateCreature("%tutu_scripth%obelite",[1879.1097],4)
Shout(ALERT)
Enemy()
~ EXIT
END
